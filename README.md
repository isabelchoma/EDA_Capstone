...
| Feature              | Data_Type          |
|:---------------------|:-------------------|
| fixed.acidity        | Numerical interval |
| volatile.acidity     | Numerical interval |
| citric.acid          | Numerical interval |
| residual.sugar       | Numerical interval |
| chlorides            | Numerical interval |
| free.sulfur.dioxide  | Numerical interval |
| total.sulfur.dioxide | Numerical interval |
| density              | Numerical interval |
| pH                   | Numerical interval |
| sulphates            | Numerical interval |
| alcohol              | Numerical interval |
| quality              | Ordinal            |
...
|  | Mean : 8.32 | Mean :0.5278 | Mean :0.271 | Mean : 2.539 | Mean :0.08747 | Mean :15.87 | Mean : 46.47 | Mean :0.9967 | Mean :3.311 | Mean :0.6581 | Mean :10.42 | NA |
...
|  | Mean : 6.855 | Mean :0.2782 | Mean :0.3342 | Mean : 6.391 | Mean :0.04577 | Mean : 35.31 | Mean :138.4 | Mean :0.9940 | Mean :3.188 | Mean :0.4898 | Mean :10.51 | NA |
...
Normality of groups (because quality is ordinal, they will not be normal):
    ...
    ## 
    ## data:  redwine_data$alcohol
    ## W = 0.92884, p-value < 2.2e-16

    ## 
    ##  Shapiro-Wilk normality test
    ## 
    ## data:  whitewine_data$alcohol
    ## W = 0.9553, p-value < 2.2e-16

    ## 
    ##  Shapiro-Wilk normality test
    ## 
    ## data:  redwine_data$quality
    ## W = 0.85759, p-value < 2.2e-16

    ## 
    ##  Shapiro-Wilk normality test
    ## 
    ## data:  whitewine_data$quality
    ## W = 0.88904, p-value < 2.2e-16

    ## 
    ##  Shapiro-Wilk normality test
    ## 
    ## data:  whitewine_data$residual.sugar
    ## W = 0.88457, p-value < 2.2e-16

    ## 
    ##  Shapiro-Wilk normality test
    ## 
    ## data:  redwine_data$residual.sugar
